...
export class ReportsReportsComponent implements OnInit, AfterViewInit {
  ...
  loadCompLoader(): void {
      ...
      this.componentRef.instance.data = this.timelineData;
      this.componentRef.instance.type = 'timeseries';
      this.componentRef.instance.config = this.timelineConfig;
      this.componentRef.instance.schema = this.timelineSchema;
