...
export class ReportsReportsComponent implements OnInit, AfterViewInit {
  ...
  loadCompLoader(): void {
      ...
      this.componentRef.instance.data = StockTurns.data;
      this.componentRef.instance.type = 'timeseries';
      this.componentRef.instance.config = StockTurns.configurations;
      this.componentRef.instance.schema = StockTurns.schema;
