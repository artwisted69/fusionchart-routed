...
import { Component, OnInit, ViewChild, TemplateRef, ViewContainerRef, AfterViewInit, ComponentFactoryResolver, ComponentRef, OnDestroy, AfterContentChecked, AfterContentInit } from '@angular/core';
...
export class ReportsReportsComponent implements OnInit, AfterViewInit, OnDestroy, AfterContentInit {
