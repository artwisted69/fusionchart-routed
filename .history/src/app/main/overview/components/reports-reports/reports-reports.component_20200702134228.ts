...
export class ReportsReportsComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    @ViewChild('chartsContainer', {read: ViewContainerRef, static: false}) chartContainer: ViewContainerRef;
  ...
  loadSample() {
      ...
      this.componentRef = this.container.createComponent(factory, 20);
      const options = {
        type: 'column3d',
